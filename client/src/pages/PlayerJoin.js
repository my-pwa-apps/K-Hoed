...
export default function PlayerJoin() {
    ...
    const handleJoin = async () => {
        ...
        try {
            ...
            sessionStorage.setItem(storageKey, JSON.stringify({ playerId, displayName: trimName, avatarEmoji: avatar }));
            navigate("/play", {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-brand-950 to-accent-600 flex flex-col items-center justify-center p-4", children: [_jsx("div", { className: "absolute top-4 right-4", children: _jsx(LanguagePicker, { light: true }) }), _jsxs("div", { className: "w-full max-w-sm", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("img", { src: "/logo.png", alt: "K-Hoed", className: "h-28 w-28 mx-auto object-contain" }), _jsx("h1", { className: "mt-2 font-display font-extrabold text-4xl text-white", children: "K-Hoed" }), _jsx("p", { className: "text-white/70 mt-2", children: t.join.subtitle })] }), _jsxs(AnimatePresence, { mode: "wait", children: [step === "info" && (_jsxs(motion.div, { initial: { opacity: 0, x: -30 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -30 }, className: "bg-white rounded-3xl shadow-2xl p-8 space-y-4", children: [error && (_jsxs("div", { role: "alert", className: "flex items-start gap-2 text-sm text-danger-600 bg-danger-50 rounded-xl p-3", children: [_jsx(AlertCircle, { size: 16, className: "shrink-0 mt-0.5", "aria-hidden": true }), error] })), _jsxs("form", { onSubmit: goToAvatar, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "label", htmlFor: "room-code", children: t.join.room_code_label }), _jsx("input", { id: "room-code", type: "text", inputMode: "text", autoComplete: "off", autoCapitalize: "characters", className: "input text-2xl font-mono font-bold tracking-widest uppercase text-center", placeholder: "ABCD12", maxLength: 6, required: true, value: code, onChange: (e) => setCode(e.target.value.toUpperCase().replace(/[^A-Z0-9]/g, "")), "aria-describedby": "room-code-hint" }), _jsx("p", { id: "room-code-hint", className: "mt-1 text-xs text-gray-400 text-center", children: t.join.room_code_hint })] }), _jsx(Input, { label: t.join.nickname_label, type: "text", required: true, placeholder: t.join.nickname_placeholder, maxLength: 30, value: displayName, onChange: (e) => setDisplayName(e.target.value) }), _jsxs(Button, { type: "submit", fullWidth: true, size: "lg", children: [t.join.next ?? "Next", _jsx(ArrowRight, { size: 18, "aria-hidden": true })] })] })] }, "info")), step === "avatar" && (_jsxs(motion.div, { initial: { opacity: 0, x: 30 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: 30 }, className: "bg-white rounded-3xl shadow-2xl p-8 space-y-5", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("button", { type: "button", onClick: () => setStep("info"), className: "p-2 rounded-xl text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors", "aria-label": "Back", children: _jsx(ArrowLeft, { size: 18 }) }), _jsxs("div", { children: [_jsx("p", { className: "font-display font-bold text-lg text-gray-900", children: t.chat.pick_avatar }), _jsx("p", { className: "text-sm text-gray-500", children: displayName })] }), _jsx("span", { className: "ml-auto text-4xl", children: avatar })] }), _jsx(AvatarPicker, { selected: avatar, onSelect: (a) => setAvatar(a) }), _jsx(Button, { fullWidth: true, size: "lg", onClick: handleJoin, loading: loading, disabled: !avatar, children: t.join.join_button })] }, "avatar"))] })] })] }));
}
