...
export default function HostGame() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-brand-950 to-brand-800 text-white flex flex-col", children: [_jsx(ReactionOverlay, {}), _jsxs("div", { className: "flex items-center justify-between px-4 py-2 bg-black/20 shrink-0 gap-3", children: [_jsx("span", { className: "text-sm font-medium text-white/70 shrink-0", children: interp(t.host_game.question_progress, {
                            n: currentQuestionIndex + 1,
                            m: totalQuestions,
                        }) }), phase === "question" && questionStartTime > 0 && (_jsx(Timer, { timeLimit: timeLimit, startTime: questionStartTime, size: 52 })), _jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [allAnswered && phase === "question" && (_jsxs("span", { className: "flex items-center gap-1 text-xs font-semibold text-emerald-300 bg-emerald-900/50 px-2 py-0.5 rounded-full", children: [_jsx(CheckCircle2, { size: 12, "aria-hidden": true }), " Iedereen heeft geantwoord"] })), phase === "question" && (_jsxs("span", { className: "flex items-center gap-1 text-sm text-white/60", children: [_jsx(BarChart3, { size: 14, "aria-hidden": true }), answerCount, "/", players.length] })), _jsxs("span", { className: "flex items-center gap-1 text-sm text-white/60", children: [_jsx(Users, { size: 14, "aria-hidden": true }), players.length] })] })] }), roomCode && (_jsx("div", { className: "px-4 pt-3 shrink-0", children: _jsx(JoinPanel, { roomCode: roomCode, dark: true, compact: true }) })), _jsxs("div", { className: "flex-1 flex min-h-0", children: [_jsxs("div", { className: "flex-1 flex flex-col min-h-0 max-w-3xl mx-auto w-full", children: [_jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 space-y-4", children: [phase === "lobby" && (_jsx("div", { className: "text-center py-8", children: _jsx("p", { className: "text-white/60", children: t.host_game.waiting }) })), (phase === "question" || phase === "revealing") && currentQuestion && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "w-full bg-white/10 rounded-2xl px-5 py-4", children: [_jsx("h2", { className: "font-display font-bold text-xl sm:text-2xl text-center leading-snug", children: currentQuestion.text }), currentQuestion.imageUrl && (_jsx("img", { src: currentQuestion.imageUrl, alt: "Question illustration", className: "max-h-40 mx-auto rounded-xl object-cover mt-3" })), (currentQuestion.type === "audioclip" || currentQuestion.type === "videoclip") && currentQuestion.mediaUrl && (_jsx("div", { className: "mt-3", children: _jsx(MediaEmbed, { url: currentQuestion.mediaUrl, type: currentQuestion.type }) }))] }), (currentQuestion.type === "classic" || currentQuestion.type === "multiple" || currentQuestion.type === "truefalse") && (_jsx("div", { className: "grid grid-cols-2 gap-3 w-full", children: currentQuestion.answerOptions.map((opt, i) => {
