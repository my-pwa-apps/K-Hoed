...
export default function HostGame() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-brand-950 to-brand-800 text-white flex flex-col", children: [_jsx(ReactionOverlay, {}), _jsxs("div", { className: "flex items-center justify-between px-6 py-3 bg-black/20", children: [_jsx("span", { className: "text-sm font-medium text-white/70", children: interp(t.host_game.question_progress, {
                            n: currentQuestionIndex + 1,
                            m: totalQuestions,
                        }) }), _jsx("span", { className: "font-mono font-bold text-white/70 text-sm", children: roomCode }), _jsxs("div", { className: "flex items-center gap-2 text-white/70 text-sm", children: [_jsx(Users, { size: 14, "aria-hidden": true }), players.length] })] }), _jsxs("div", { className: "flex-1 flex flex-col items-center justify-start px-4 py-8 max-w-4xl mx-auto w-full gap-6", children: [phase === "lobby" && (_jsx("div", { className: "text-center", children: _jsx("p", { className: "text-white/60", children: t.host_game.waiting }) })), (phase === "question" || phase === "revealing") && currentQuestion && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "w-full bg-white/10 rounded-3xl p-6 text-center", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("span", { className: "text-sm text-white/60", children: interp(t.host_game.question_progress, { n: currentQuestionIndex + 1, m: totalQuestions }) }), phase === "question" && (_jsx(Timer, { timeLimit: timeLimit, startTime: questionStartTime, size: 72 })), _jsxs("div", { className: "flex items-center gap-1 text-sm text-white/60", children: [_jsx(BarChart3, { size: 14, "aria-hidden": true }), interp(t.host_game.answer_count, { count: answerCount, total: players.length })] })] }), currentQuestion.imageUrl && (_jsx("img", { src: currentQuestion.imageUrl, alt: "Question illustration", className: "max-h-48 mx-auto rounded-2xl object-cover mb-4" })), _jsx("h2", { className: "font-display font-bold text-2xl sm:text-3xl text-shadow", children: currentQuestion.text })] }), (currentQuestion.type === "classic" || currentQuestion.type === "multiple" || currentQuestion.type === "truefalse") && (_jsx("div", { className: "grid grid-cols-2 gap-3 w-full", children: currentQuestion.answerOptions.map((opt, i) => {
