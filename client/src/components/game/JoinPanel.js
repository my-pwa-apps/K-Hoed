...
export function JoinPanel({ roomCode, dark = false, compact = false }) {
    ...
    if (compact) {
        return (_jsxs("div", { className: `flex items-center gap-3 rounded-2xl px-4 py-3 ${bg}`, children: [_jsx("img", { src: qr, alt: "QR code to join", width: 56, height: 56, className: "rounded-lg shrink-0" }), _jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: `text-xs font-medium mb-0.5 ${sub}`, children: "Scan or visit" }), _jsx("p", { className: `text-xs ${sub} truncate`, children: STATIC_JOIN_URL }), _jsx("div", { className: `inline-block font-mono font-extrabold text-xl tracking-widest rounded-lg px-2 py-0.5 mt-1 ${codeBg} ${codeText}`, children: roomCode })] })] }));
    }
